...
public interface BillRepository extends JpaRepository<Bill, Long> {
    ...
    List<Bill> findByRoomIdAndMonth(Long roomId, int month);

    List<Bill> findByRoomIdAndYear(Long roomId, int year);

    List<Bill> findByTenantId(Long tenantId);

    List<Bill> findByTenantIdAndMonthAndYear(Long tenantId, int month, int year);

    List<Bill> findByTenantIdAndMonth(Long tenantId, int month);

    List<Bill> findByTenantIdAndYear(Long tenantId, int year);
}
